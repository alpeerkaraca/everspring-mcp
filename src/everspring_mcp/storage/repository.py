    ...
    async def insert(self, doc: DocumentRecord) -> None:
        ...
        await self.db.execute(
            ...
            (
                ...
                doc.schema_version, int(doc.is_indexed),
            ),
        )
    ...
    async def complete_sync(
        ...
        await self.db.execute(
            ...
            (
                ...
                datetime.now(timezone.utc).isoformat(),
                files_added, files_modified, files_removed, bytes_downloaded,
                sync_id,
            ),
        )
        await self.db.commit()
        logger.info(
            ...
            sync_id, files_added, files_modified, files_removed, bytes_downloaded,
        )
